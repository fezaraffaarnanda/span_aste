...
# -----------------
print("\n\n🧠 MODEL SPAN-ASTE: BAGAIMANA INI BEKERJA?")
print("=" * 70)
...
# -----------------
# BAGIAN 7: KESIMPULAN DAN TIPS
# -----------------
print("\n\n🌟 KESIMPULAN & TIPS FINE-TUNING")
print("=" * 70)

print("""
KESIMPULAN:

Model SPAN-ASTE bekerja dengan:
1. Mengidentifikasi semua span (rentang teks) potensial
2. Mengklasifikasikan span sebagai aspek, opini, atau invalid
3. Membentuk pasangan aspek-opini
4. Mengklasifikasikan sentimen untuk setiap pasangan

TIPS FINE-TUNING:

1. Data Preparation:
   - Pastikan format data sudah benar
   - Periksa apakah indeks aspek dan opini sudah akurat
   - Perbanyak data training untuk hasil lebih baik

2. Hyperparameter:
   - Learning rate: 5e-5 untuk BERT, 1e-3 untuk lapisan lain
   - Batch size: sesuaikan dengan kapasitas GPU (1-8)
   - Span pruning threshold: sesuaikan (0.3-0.5)
   - Maksimum panjang span: umumnya 5-8 token

3. Training:
   - Monitor loss training dan F1 validasi
   - Simpan model dengan F1 validasi terbaik
   - Jika F1 tidak meningkat, coba:
     * Ubah learning rate
     * Tambah/kurangi batch size
     * Tambah data training

4. Validasi:
   - Selalu validasi model secara berkala
   - Perhatikan precision dan recall, bukan hanya F1
   - Analisis kesalahan untuk perbaikan

5. Penggunaan Output:
   - Output model adalah triplet (aspek, opini, sentimen)
   - Dapat digunakan untuk analisis sentimen terperinci
   - Cocok untuk analisis review produk, feedback, dll.
""")

print("\n🎉 AKHIR TUTORIAL - SEMOGA BERMANFAAT!")